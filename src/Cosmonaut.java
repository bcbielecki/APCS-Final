...
public class Cosmonaut extends Obstacle {
	public Cosmonaut(double x, double y, double w, double h, double vx, double vy) {
	...
	private static Image setImage() {
		Image img = null;
		try {
			img = new Image(new FileInputStream("media/images/obstacles/cosmonaut.png"));
